#!/usr/bin/env python3
"""
Script SEM_so101_control_follower.py
Service Ecoles Médias - Contrôle manuel du Follower SO-ARM 101

Ce script permet de :
1. Contrôler le Follower depuis le PC
...
print("""
╔══════════════════════════════════════════════════════════╗
║     SEM - CONTROLE FOLLOWER SO-ARM 101                  ║
...
calib_file = os.path.expanduser("~/.cache/calibration/so101/follower_calibration.json")
...
try:
    while True:
        ...
        servo_names = {1:"BASE", 2:"EPAULE", 3:"COUDE", 4:"POIGNET-F", 5:"POIGNET-R", 6:"PINCE"}
