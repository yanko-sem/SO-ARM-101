...
- Configuration des modes (côte à côte / face à face)
- Synchronisation temps réel
- Mouvements miroir ou copie
...
- Installation des caméras USB
- Configuration OpenCV
- Test d'affichage vidéo
- Téléopération avec retour caméra
...
graph LR
    ...
    E --> F[Phase 6<br/>Caméras]
    F --> G[Phase 7<br/>Enregistrement]
    G --> H[Phases 8-10<br/>IA & Autonomie]
```
...
- 1x PC Ubuntu 22.04+
- 2x Caméras USB (à partir de la phase 6)
...
5. **Caméras** : Brancher sur des ports USB différents pour éviter les conflits de bande passante
